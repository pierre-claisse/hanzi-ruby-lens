...
export function RubyWord({ word, showPinyin = true }: RubyWordProps) {
  return (
    <ruby className="font-hanzi rounded pt-6 pb-1.5 transition-colors duration-200 ease-in-out hover:bg-accent/24 focus-visible:ring-2 focus-visible:ring-accent">
      {word.characters}
      <rp>(</rp>
